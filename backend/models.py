...
class RawImage(DBRecord):
    image_id: str = Field(description="The ID linking this raw image to the corresponding ImageDataDB record")
    image_b64: str = Field(description="The base64-encoded cropped image")
