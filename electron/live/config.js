...
const TAKE_SCREENSHOT_DECLARATION = {
...
function composeSystemInstruction(runtimeConfig) {
...
function buildRealtimeInputConfig(runtimeConfig) {
...
function buildLiveConnectConfig(runtimeConfig, sessionResumptionHandle = '') {
...
function getLiveRuntimeConfig(options = {}) {
